...
public class Evasion implements Behavior {

	private Locomotion otherBoid;
	private Locomotion boid;

	public Evasion(Locomotion boid, Locomotion otherBoid) {
		this.boid = boid;
	...
	public Vector2D steeringForce() {
		return Steering.evade(boid, otherBoid);
	}

	public Locomotion getOtherBoid() {
		return otherBoid;
	}

	public void setOtherBoid(Locomotion otherBoid) {
		this.otherBoid = otherBoid;
	}
